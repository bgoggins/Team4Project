...
//	}
	...
	public ResponseEntity<?> addRegistration(@RequestBody Registration newRegistration, UriComponentsBuilder uri) {
		if (newRegistration.getId() != 0 || newRegistration.getEventID() == null || newRegistration.getCustomerID() == null ||
					newRegistration.getNotes() == null || newRegistration.getRegistrationDate() == null) {
	...
	public ResponseEntity<?> putRegistration(@RequestBody Registration newRegistration,
		...
		if (newRegistration.getId() !=  registrationId || newRegistration.getEventID() == null || newRegistration.getCustomerID()== null ||
				newRegistration.getNotes() == null || newRegistration.getRegistrationDate() == null) {
			return ResponseEntity.badRequest().build();
		}
		newRegistration = repo.save(newRegistration);
