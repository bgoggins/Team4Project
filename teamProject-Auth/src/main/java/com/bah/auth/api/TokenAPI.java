...
import com.bah.auth.domain.Customer;
import com.bah.auth.domain.CustomerFactory;
import com.bah.auth.domain.Token;
import com.bah.auth.util.JWTHelper;
...
public class TokenAPI {
	...
	private static Token createToken(String username) {
		String scopes = "com.bah.data.apis";
		// special case for application user
